...
export default function Technologies() {
    ...
    return (
            <section className="row ms-lg-2 animatedAbout mb-7" id="home">

                {/* Left Content - About Me Text */}
                <div className="about-me-content col-lg-7 d-flex flex-column align-items-center align-items-lg-start mb-5">
                ...
                <div className="col-lg-5 d-flex flex wrap border border-primary">
                    <div>
